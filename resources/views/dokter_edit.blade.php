            ...
            <form action="/dokter/{{ $dokter->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mt-3">
                    ...
                    <select name="jadwal" class="form-control">
                        <option value="pagi" @selected($dokter->jadwal == 'pagi')>07.30 Am - 13.30 Pm</option>
                        <option value="siang" @selected($dokter->jadwal == 'siang')>13.50 Pm - 17.30 Pm</option>
                        <option value="sore" @selected($dokter->jadwal == 'sore')>
                        18.05 Pm - 20.00 Pm
                        </option>
                        <option value="malam" @selected($dokter->jadwal == 'malam')> 20.10 Pm - 01.00 Am </option>
                    </select>
